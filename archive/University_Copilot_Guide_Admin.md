...
### [Step 1] 준비물 챙기기
1.  작년 사업계획서 파일()을 엽니다. (없으면 아무 내용이나 채워서 만드세요.)
2.  올해의 중점 추진 과제가 담긴 메모()를 만듭니다.
...
### [Step 3] 명령 내리기
> **입력(Input):**
> "작년 계획서()를 바탕으로 를 새로 만들어줘.
> 단, 에 있는 올해 중점 과제를 반영해서 '추진 전략' 부분을 수정해야 해.
