...
| AI 이름 | 만든 회사 | 이런 분께 추천해요 | 한 달에 몇 번? |
|---------|----------|-------------------|--------------|
| **GPT-4o** | OpenAI | 일반적인 질문, 빠른 답변이 필요할 때 | **월 50회** 채팅 |
| **Claude 3.5 Sonnet** | Anthropic | 긴 글 작성, 보고서 초안, 자연스러운 문장 | **월 50회** 채팅 |

> **💡 참고:** "월 50회"는 질문을 50번 할 수 있다는 뜻입니다. **추가 질문도 1회로 카운트**되니, 한 번에 여러 질문을 묶어서 하는 것이 좋습니다!
...
**GitHub Education 혜택**을 받으면 훨씬 더 많은 AI를 사용할 수 있습니다!

| AI 이름 | 만든 회사 | 특별한 점 | 한 달에 몇 번? |
|---------|----------|----------|--------------|
| **GPT-4o** | OpenAI | 가장 유명한 AI, 빠르고 정확함 | **무제한** 🎉 |
| **Claude 3.5 Sonnet** | Anthropic | 코딩에 특히 강함, 자연스러운 글쓰기 | **무제한** 🎉 |
| **Gemini 1.5 Pro** | Google | 방대한 정보 처리, 긴 문서 분석에 탁월 | **무제한** 🎉 |
| **o1-preview** | OpenAI | 복잡한 수학, 논리적 추론 전문 (느리지만 정확) | **주당 30-50회** |
| **o1-mini** | OpenAI | o1-preview의 경량 버전 (빠른 추론) | **주당 30-50회** |

> **🎁 핵심 혜택:** 대학 구성원은 GPT-4o, Claude, Gemini를 **무제한**으로 사용할 수 있습니다! (o1 시리즈만 횟수 제한)
...
graph TD
    ...
    B -->|일반 질문, 빠른 답변| C[GPT-4o 추천]
    B -->|보고서/글쓰기| D[Claude 3.5 Sonnet 추천]
    B -->|긴 문서 분석| E[Gemini 1.5 Pro 추천]
    B -->|복잡한 수학/논리 문제| F[o1-preview 추천]
...
| 하고 싶은 일 | 추천 AI | 이유 |
|------------|---------|------|
| 이메일 초안 작성 | Claude 3.5 Sonnet | 자연스럽고 정중한 문장 |
| 데이터 분석 아이디어 | GPT-4o | 빠르고 다양한 제안 |
| 100페이지 논문 요약 | Gemini 1.5 Pro | 긴 문서 처리에 강함 |
| 수학 증명 문제 | o1-preview | 단계별 논리적 추론 |
...
|------|--------------------------|---------------------------|
| **사용 가능한 AI** | GPT-4o, Claude 3.5 | GPT-4o, Claude 3.5, Gemini 1.5,<br/>o1-preview, o1-mini |
| **한 달 질문 횟수** | 50회 | **무제한** (표준 모델)<br/>주 30-50회 (o1 모델) |
| **VS Code에서 사용** | 제한적 | 무제한 자동 완성 |
| **데이터 보호** | 학습에 사용될 수 있음 | **학습에 절대 사용 안 함** 보장 |

**쉽게 말하면:**
- 무료 사용자: 한 달에 50번만 질문 가능
- 대학 구성원: **거의 무제한**으로 질문 가능! 🎉
...
**추천 AI:** Claude 3.5 Sonnet (자연스럽고 정중한 문장 생성에 강함)
...
**추천 AI:** Gemini 1.5 Pro (긴 문서 처리에 최적화)
...
단계별로 풀이 과정을 보여주고, 
각 단계마다 왜 그렇게 하는지 설명해줘.
```

**추천 AI:** o1-preview (논리적 추론과 수학 문제에 최적화)

**팁:** o1 모델은 "생각하는 시간"이 필요해서 답변이 느립니다. 하지만 복잡한 문제일수록 훨씬 정확한 답을 제공합니다!
...
**대학 구성원 (표준 모델은 무제한):**
- GPT-4o, Claude, Gemini는 **무제한**이므로 걱정 없습니다.
- o1 모델만 주당 30-50회 제한이 있지만, 일주일이 지나면 다시 충전됩니다.
...
| 상황 | 추천 모델 | 한 줄 이유 |
|------|----------|----------|
| 빨리 답을 얻고 싶을 때 | GPT-4o | 가장 빠르고 범용적 |
| 글을 예쁘게 쓰고 싶을 때 | Claude 3.5 | 문장력이 뛰어남 |
| 긴 문서를 분석할 때 | Gemini 1.5 Pro | 많은 양을 한 번에 처리 |
| 수학/논리 문제를 풀 때 | o1-preview | 단계별 추론 능력 최고 |

**처음이라면:** GPT-4o로 시작하세요! 가장 무난하고 빠릅니다.
...
### 2️⃣ **성능 MAX!**
👉 GPT-4o, Claude 3.5, Gemini 1.5 Pro를 골라서 사용!
