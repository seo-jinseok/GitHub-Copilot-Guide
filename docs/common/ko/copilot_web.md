...
- **특이 사항:** "0x"라고 표시된 모델을 사용하더라도, 무료 사용자는 **보유한 50회 한도에서 1회가 차감**됩니다.
...
가장 헷갈리는 부분이죠! **"내 신분(무료 vs 대학)"**에 따라 의미가 완전히 다릅니다.

| 구분 | **0x (Standard)** 모델을 쓸 때 | **1x (Premium)** 모델을 쓸 때 |
|------|-----------------------------|-----------------------------|
| **무료 사용자** | 내 한도(50회)에서 **1회 차감** 😭 | 내 한도(50회)에서 **1회 차감** 😭 |
| **대학 구성원** | **차감 없음 (완전 무료/무제한)** 🎉 | **1 크레딧 차감** (월 300회 한도 내) |

> **🎁 결론:** 대학 구성원이라면 **"0x 모델은 공짜, 1x 모델은 월 300개 티켓으로 쓴다"**고 이해하시면 가장 정확합니다!
